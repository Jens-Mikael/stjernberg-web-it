import { ArrowRight, Check, Cloud, CodeXml, Server } from "lucide-react";
...
export default function WhatWeOfferSoftwareDevelopment() {
  ...
  return (
    <div className="px-5 sm:px-10 lg:px-20 xl:px-30 py-20 flex justify-center flex-col items-center gap-20 bg-base-light">
      <div className="flex flex-col gap-20 max-w-[1800px] w-full">
                ...
                <div className="flex gap-5">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {item.tools.map((tool) => (
                        <div className="rounded-md px-1.5 py-0.5 border-main bg-main/10 text-main border">
                          {tool}
                        </div>
                      ))}
                    </div>
